...
const HTML_ASSET = resolveAssetSource(require('../assets/epub-viewer/viewer.html'));
...
export const EpubViewer = forwardRef<ViewerHandle, Props>(({ uri, onSearchResult, onViewerMessage }, ref) => {
