...
export function TextImportModal({ visible, initialContent = '', initialTitle = '', onClose, onSave }: Props) {
    ...
    <View style={styles.overlay}>
      ...
      >
        <View style={[styles.header, { backgroundColor: theme.colors.surface, borderBottomColor: theme.colors.border }]}>
          ...
          <Text style={[styles.headerTitle, { color: theme.colors.textPrimary }]}>New Text</Text>
          <TouchableOpacity style={styles.headerBtn} onPress={handleSave} disabled={!content.trim()}>
            <CheckmarkSquare02Icon size={24} color={content.trim() ? theme.colors.primary : theme.colors.textSecondary} />
          </TouchableOpacity>
        </View>
