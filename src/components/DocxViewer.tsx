...
const HTML_ASSET = resolveAssetSource(require('../assets/mammoth/viewer.html'));
...
export function DocxViewer({ uri }: Props) {
  ...
  // Both must be ready before we can send the payload
  ...
  }, [theme.colors.darkBg, theme.colors.textPrimary, theme.colors.primary]);

  // Fire whenever both sides become ready
  useEffect(() => {
